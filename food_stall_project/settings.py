...
ROOT_URLCONF = 'food_stall_project.urls'
...
WSGI_APPLICATION = 'food_stall_project.wsgi.application'
...
# Break time slots available for pre-ordering
...
# Max orders per slot to control crowd
